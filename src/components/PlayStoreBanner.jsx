...
const defaultPlayUrl =
  "https://play.google.com/store/apps/details?id=com.meetmap.app";
const defaultAppStoreUrl =
  "https://apps.apple.com/us/app/meet-map-car-meets/id6775626296";
...
export default function PlayStoreBanner() {
  ...
  const playUrl =
    String(import.meta.env.VITE_PLAY_STORE_URL || defaultPlayUrl).trim() ||
    defaultPlayUrl;
  const appStoreUrl =
    String(import.meta.env.VITE_APP_STORE_URL || defaultAppStoreUrl).trim() ||
    defaultAppStoreUrl;
  ...
  const shell = (
    <div
      ...
      role="dialog"
      aria-label="Get the Meet Map mobile app"
      style={outer}
    >
      {placement === "top" ? (
        <div
        ...
        >
          ...
          >
            ...
            >
              Download the app for saved-meet alerts and a faster map.
            </span>
          </div>
          <div
            style={{
        ...
        >
          ...
          >
            <div style={{ minWidth: 0 }}>
              ...
              >
                Meet Map is now available on iOS and Android with saved-meet
                alerts and a faster map.
              </p>
            </div>
            <button
              type="button"
